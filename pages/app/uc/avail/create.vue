      ...
      <div class="max-w-3xl mx-auto">
        <div class="mb-10">
          <NuxtLink to="/app/uc/avail" 
            ...
            <div class="p-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 mr-3 group-hover:bg-primary-50 dark:group-hover:bg-primary-900/30 transition-colors">
        ...
        <form @submit.prevent="submitAvailability" class="space-y-8">
          <!-- Véhicule Selection -->
          <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-[2.5rem] border border-white dark:border-gray-700 p-8 shadow-xl shadow-gray-200/50 dark:shadow-none">
            ...
            <div v-if="error" class="mb-8 p-4 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800/50 text-red-600 rounded-2xl text-sm font-bold flex items-center">
            ...
            <div class="space-y-6">
              <div>
                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Choix du véhicule</label>
                <div v-if="loadingVehicles" class="flex items-center p-4 bg-gray-50 dark:bg-gray-900/30 rounded-2xl border border-gray-100 dark:border-gray-800">
                ...
                <div v-else-if="vehicles.length === 0" class="p-6 bg-amber-50 dark:bg-amber-900/20 rounded-2xl border border-amber-100 dark:border-amber-800/50">
                  <p class="text-amber-700 dark:text-amber-400 font-bold mb-4">Vous n'avez pas encore enregistré de véhicule.</p>
                  <NuxtLink to="/app/uc/vehicles" class="inline-flex px-6 py-2 bg-amber-600 text-white rounded-xl text-sm font-black hover:bg-amber-700 transition-all">
                    Ajouter un véhicule
                  </NuxtLink>
                </div>
                <div v-else class="relative group">
                  ...
                  <IconChevronDown class="absolute right-6 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none group-hover:text-secondary-600 transition-colors" />
                </div>
              </div>

              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                <div>
                  <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Tarif souhaité (FCFA)</label>
                  <div class="relative">
                ...
                <div>
                  <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Capacité Max (Demandes)</label>
          ...
          <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-[2.5rem] border border-white dark:border-gray-700 p-8 shadow-xl shadow-gray-200/50 dark:shadow-none">
            ...
            <div class="space-y-10">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Départ prévu</label>
                  <div class="relative">
                ...
                <div>
                  <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3 ml-1">Fin du trajet</label>
                  <div class="relative">
              ...
              <div class="space-y-10">
                <div class="p-8 bg-gray-50/50 dark:bg-gray-900/30 rounded-[2rem] border border-gray-100 dark:border-gray-800 relative group transition-all hover:border-emerald-200">
                  <div class="absolute -left-3 top-1/2 -translate-y-1/2 w-1.5 h-12 bg-emerald-500 rounded-full"></div>
                  <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-6 px-1">Point d'origine (Départ)</label>
                ...
                <div class="p-8 bg-gray-50/50 dark:bg-gray-900/30 rounded-[2rem] border border-gray-100 dark:border-gray-800 relative group transition-all hover:border-red-200">
                  <div class="absolute -left-3 top-1/2 -translate-y-1/2 w-1.5 h-12 bg-red-400 rounded-full"></div>
                  <div class="flex justify-between items-center mb-6 px-1">
                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Destination finale (Arrivée)</label>
                    <span class="text-[10px] font-black text-gray-400 bg-white dark:bg-gray-800 px-2 py-0.5 rounded-lg border border-gray-100 dark:border-gray-700 uppercase tracking-widest">Optionnel</span>
                  </div>
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
