  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 pb-12">
    <div class="container-custom pt-8">
      ...
      <div class="flex items-center justify-between mb-8">
        <button @click="router.back()" class="flex items-center text-gray-600 dark:text-gray-400 hover:text-secondary-600 transition-colors">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
              ...
              <button v-if="document?.downloadUrl || document?.url" @click="handleDownload" class="btn btn-secondary btn-sm" :disabled="isDownloading">
            ...
            <div class="p-8 bg-gray-50 dark:bg-gray-900/50 flex items-center justify-center min-h-[400px]">
              ...
              <div v-else-if="document" class="w-full text-center">
                 <div v-if="isImage" class="relative group inline-block">
                    ...
                    <img v-else-if="previewUrl" :src="previewUrl" :alt="document.name" class="max-w-full h-auto rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 mx-auto" />
                 ...
                 <div v-else class="p-12 bg-white dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700">
        ...
        <div class="space-y-6">
          ...
          <div class="bg-secondary-50 dark:bg-secondary-900/20 rounded-2xl p-6 border border-secondary-100 dark:border-secondary-900/30">
