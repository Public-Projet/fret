        ...
        <div class="lg:col-span-2 space-y-6">
          <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
              ...
              <button v-if="document?.downloadUrl || document?.url" @click="handleDownload" class="btn btn-primary btn-sm" :disabled="isDownloading">
            ...
            <div class="p-8 bg-gray-50 dark:bg-gray-900/50 flex items-center justify-center min-h-[400px]">
              ...
              <div v-else-if="document" class="w-full text-center">
                 ...
                 <div v-else class="p-12 bg-white dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700">
                    ...
                    <button @click="handleDownload" class="btn btn-outline btn-primary" :disabled="isDownloading">
