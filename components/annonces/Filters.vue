<template>
  <div
    ...
    <div class="flex flex-col space-y-6">
      <!-- Tabs Selection -->
      <div
        class="flex p-1.5 bg-gray-100/80 dark:bg-gray-700/80 backdrop-blur-md rounded-2xl w-full sm:w-fit self-center sm:self-start">
      ...
      <div v-if="activeTab === 'avail'" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        <div class="space-y-1.5">
          <label
            class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] ml-1">Départ</label>
        ...
        <div class="space-y-1.5">
          <label
            class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] ml-1">Arrivée</label>
          <div class="relative group">
            <IconMapPin
              class="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-primary-500 transition-colors" />
        ...
        <div class="space-y-1.5">
          <label
            class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] ml-1">Date</label>
          <div class="relative group">
            <IconCalendar
              class="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-primary-500 transition-colors" />
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div class="space-y-1.5">
          <label
            class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] ml-1">Marchandise</label>
