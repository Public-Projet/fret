  ...
  <div class="space-y-8">
    ...
    <div class="space-y-8">
      <div
        ...
        <div
          class="flex flex-wrap items-center gap-y-2 gap-x-4 text-sm text-gray-500 dark:text-gray-400 mb-6 border-b border-gray-50 dark:border-gray-700 pb-4">
            ...
            <div class="relative">
              ...
              <div>
                <p
                  ...
                  Livraison</p>
                <p class="font-medium text-gray-900 dark:text-white text-lg">
                  {{ item.destination?.city }} <span v-if="item.destination?.postalCode">({{
                    item.destination?.postalCode }})</span>
                </p>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div
            class="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-2xl text-center border border-gray-100 dark:border-gray-700 font-mono">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div
          ...
          <div class="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <div class="flex items-center text-sm">
                ...
                <span class="font-black text-gray-700 dark:text-gray-300">{{ (item.shipper || item.user)?.rating ||
                  '0.0' }}</span>
          ...
          <div class="space-y-4">
            <div
              class="flex items-center p-3 bg-green-50 dark:bg-green-900/10 rounded-xl border border-green-100 dark:border-green-900/20">
            ...
            <button v-if="canRate" @click="$emit('showRatingModal')"
              class="btn btn-secondary w-full rounded-xl py-3 mt-4 transition-all hover:scale-[1.02]">
              {{ ratingLabel }}
            </button>
          </div>
        </div>
        ...
        <div v-if="authStore.isCarrier && item.status === 'pending' && !hasAlreadyOffered"
          ...
          <p class="text-gray-500 mb-6 font-medium">Proposez vos services pour ce transport et entamez la négociation
            avec
            l'expéditeur.</p>
          <button @click="$emit('enroll')"
            class="btn btn-primary w-full py-4 rounded-2xl shadow-md shadow-primary-500/20">
