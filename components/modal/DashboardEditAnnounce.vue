    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button type="button" class="btn btn-primary w-full sm:w-auto sm:ml-3 flex items-center justify-center" :disabled="loading" @click="handleSubmit">
          ...
          <button type="button" class="mt-3 w-full sm:mt-0 sm:w-auto btn btn-ghost" :disabled="loading" @click="$emit('close')">
            Annuler
          </button>
        </div>
      </div>
