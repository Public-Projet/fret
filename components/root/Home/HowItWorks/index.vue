    ...
    <div class="container-custom relative z-10">
      ...
      <div class="relative">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          <RootHomeHowItWorksCard number="01" :icon="IconFileText" title="Publiez votre annonce"
          ...
          <RootHomeHowItWorksCard number="02" :icon="IconSearch" title="Recevez des offres"
          ...
          <RootHomeHowItWorksCard number="03" :icon="IconCircleCheck" title="Choisissez et validez"
