    ...
    <div class="container-custom relative z-10">
      ...
      <div class="relative">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          <UtilsFeatureCard number="01" :icon="IconFileText" title="Publiez votre annonce"
          ...
          <UtilsFeatureCard number="02" :icon="IconSearch" title="Recevez des offres"
          ...
          <UtilsFeatureCard number="03" :icon="IconCircleCheck" title="Choisissez et validez"
